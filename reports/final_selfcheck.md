...
**合计**：15 项 —— PASS 6 / FAIL 0 / SKIP 9 / ERROR 0
...
| 5 | 交付物里没有仓库标识与旧数字 | SKIP | 0 |
| 6 | 工具数是 6 个（不是 8） | SKIP | 0 |
| 7 | 时间线不矛盾：实习那一节里没有 MCP | SKIP | 0 |
| 8 | MCP 条的 facts 链接指向本仓 | SKIP | 0 |
| 9 | 交付物里没有金额字样 | SKIP | 0 |
| 10 | 交付物里没有夸大措辞 | SKIP | 0 |
| 11 | 守门链四项全过 | PASS | 0 |
| 12 | 单元测试退出码 0 | PASS | 0 |
